...
const HowTo = () => {
  return (
    <div className="how-to-container">
      ...
      <h3 className="about-subheader">Example Search Result</h3>
      ...
      <img className="about-search" src="https://imgur.com/o6pdnpz.png" />
      ...
      <img className="ingredients-image" src="https://imgur.com/5KJmFrD.png" />
      <ul>
        <h5 className="selected plain-header">Exact Match</h5>
        <p className="plain-header">The ingredient is in you pantry</p>
        ...
        <p className="plain-header">The ingredient is not in your pantry</p>
      </ul>
    </div>
  )
}
